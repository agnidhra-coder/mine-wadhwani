...
//   /// DraftBloc is owned here so it survives navigating away and back,
//   /// keeping the badge count accurate without an extra round-trip.
//   late final DraftBloc _draftBloc;
...
//   void initState() {
//     super.initState();
//     _draftBloc = sl<DraftBloc>()..add(const LoadDrafts());
//   }
...
//         break;
//       case 3:
//         _openPendingInspections(context);
//         break;
//       case 5:
//         Navigator.push(
//           context,
...
//   /// Opens PendingInspectionsScreen, sharing the same DraftBloc instance so
//   /// that any delete/resume inside that screen immediately updates the badge
//   /// when the user returns here.
//   void _openPendingInspections(BuildContext context) {
//     Navigator.push(
//       context,
//       MaterialPageRoute(
//         builder: (_) => BlocProvider.value(
//           value: _draftBloc,
//           child: const PendingInspectionsScreen(),
//         ),
//       ),
//     ).then((_) {
//       // Refresh count when returning in case drafts were deleted/resumed.
//       if (mounted) _draftBloc.add(const LoadDrafts());
//     });
//   }
...
//             body: Column(
//               children: [
//                 // Top bar reads DraftBloc for the CHECK PENDING badge.
...
//                         // Grid — Pending Inspections card gets a live badge.
//                         BlocBuilder<DraftBloc, DraftState>(
...
//                                   _buildDashboardCard(
//                                 _cards[index],
//                                 // Show live count badge only on the
...
//             // CHECK PENDING — live count from DraftBloc
//             GestureDetector(
//               onTap: () => _openPendingInspections(context),
//               child: Container(
//                 padding: const EdgeInsets.symmetric(
...
//                           horizontal: 6, vertical: 3),
//                       decoration: BoxDecoration(
//                         // Red when there are real drafts, muted when zero.
...
//     _DashboardCard card, {
//     VoidCallback? onTap,
//     int? badge, // non-null → show red count bubble in top-right corner
//   }) {
//     return Container(
//       decoration: BoxDecoration(
//         color: Colors.white,
