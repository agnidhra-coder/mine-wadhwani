// lib/presentation/screens/common/inspection_report_preview_page.dart
//
// Generic PDF preview & export page used by ALL inspection types.
// Replaces StockpileReportPreviewPage. Works with any List<InspectionSection>.
...
class InspectionReportPreviewPage extends StatefulWidget {
  ...
  @override
  State<InspectionReportPreviewPage> createState() =>
      _InspectionReportPreviewPageState();
}

class _InspectionReportPreviewPageState
    extends State<InspectionReportPreviewPage> {
  ...
  int get _totalAnswered => widget.sections
    .fold<int>(0, (sum, s) => sum + _answeredInSection(s));


  int get _totalQuestions =>
      widget.sections.fold(0, (sum, s) => sum + s.questions.length);

  int _answeredInSection(InspectionSection s) => s.questions
      .where((q) => (widget.answers[q.code] ?? '').isNotEmpty)
      .length;

  int get _flaggedCount =>
      widget.answers.values.where((v) => v == 'NO').length;
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) => [
          ...
          pw.Row(
            ...
            children: [
              if (logoImage != null) ...[
                pw.Container(width: 56, height: 56, child: pw.Image(logoImage)),
          ...
          pw.Container(
            ...
            child: pw.Row(
              children: [
                _pdfScoreCell(
                    'Score', '$_totalAnswered / $_totalQuestions ($scorePercent%)',
                    flex: 3),
                _pdfDivider(),
                _pdfScoreCell('Flagged', '$_flaggedCount', flex: 2),
                _pdfDivider(),
          ...
          pw.Container(
            ...
            child: pw.Row(
              children: [
                ...
                pw.Container(width: 1, height: 40, color: PdfColor.fromHex('#E0E3EA')),
                pw.Expanded(
                  child: pw.Padding(
                    padding: const pw.EdgeInsets.all(10),
                    child: pw.Column(
                      ...
                      children: [
                        pw.Text('Evaluator',
                            style: pw.TextStyle(
                                fontSize: 9, color: PdfColor.fromHex('#9CA3AF'))),
                        pw.SizedBox(height: 3),
                        pw.Text('${widget.inspectorName} (${widget.inspectorRole})',
                            style: pw.TextStyle(
                                fontSize: 11,
                                fontWeight: pw.FontWeight.bold,
                                color: PdfColor.fromHex('#1A2340'))),
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Text('$_flaggedCount flagged',
                      style: pw.TextStyle(
                          fontSize: 11, color: PdfColor.fromHex('#991B1B'))),
                ],
              ),
            ),
            pw.SizedBox(height: 8),
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                      ...
                      style: pw.TextStyle(
                          fontSize: 11, color: PdfColor.fromHex('#92400E'))),
                ],
              ),
            ),
            pw.SizedBox(height: 8),
            ...widget.sections.expand((section) {
              final actionQs = section.questions
                  .where((q) => widget.actions.containsKey(q.code))
                  .toList();
              if (actionQs.isEmpty) return <pw.Widget>[];
              return [
                pw.Text(
                  'SECTION ${widget.sections.indexOf(section) + 1}: ${section.title.toUpperCase()}',
                  style: pw.TextStyle(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          pw.Row(
                            ...
                            children: [
                              pw.Expanded(
                                child: pw.Text('${q.code}. ${action.title}',
                                    style: pw.TextStyle(
                                        fontSize: 10,
                                        fontWeight: pw.FontWeight.bold,
                                        color: PdfColor.fromHex('#1A2340'))),
          ...
          ...widget.sections.asMap().entries.map((entry) {
            ...
            return pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                pw.Text('Section ${i + 1}: ${section.title}',
                    style: pw.TextStyle(
                        fontSize: 11,
                        fontWeight: pw.FontWeight.bold,
                        color: PdfColor.fromHex('#1A2340'))),
  ...
  pw.Widget _pdfDivider() =>
      pw.Container(width: 1, height: 48, color: PdfColor.fromHex('#E0E3EA'));
      ...
      child: pw.Row(
        children: [
          pw.SizedBox(
            ...
            child: pw.Text('$label:',
                style: pw.TextStyle(
                    fontSize: 10, color: PdfColor.fromHex('#6B7280'))),
          ),
          pw.Text(value,
              style: pw.TextStyle(
                  fontSize: 10,
  ...
  Future<void> _downloadPdf() async {
    ...
    try {
      ...
      final safeType = widget.inspectionType
          .toLowerCase()
          .replaceAll(RegExp(r'[^a-z0-9]'), '_');
      final fileName =
          '${safeType}_${DateTime.now().millisecondsSinceEpoch}.pdf';
  ...
  Future<void> _sharePdf() async {
    ...
    try {
      ...
      await Printing.sharePdf(
        bytes: bytes,
        filename: '${safeType}_${widget.area}_shift${widget.shift}.pdf',
      );
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
                        ...
                        IntrinsicHeight(
                          child: Row(
                            children: [
                              ...
                              _scoreCell('Flagged items', '$_flaggedCount',
                                  flex: 2,
                              ...
                              const VerticalDivider(
                                  color: Color(0xFFE0E3EA), width: 1),
                              _scoreCell('Actions', '$_actionsCount',
                                  flex: 2,
                                      ...
                                      Text('Conducted on',
                                          style: TextStyle(
                                              ...
                                              color: AppColors.secondary
                                                  .withValues(alpha: 0.6))),
                                      const SizedBox(height: 3),
                                      Text(_formatDate(widget.reviewedAt),
                                          style: const TextStyle(
                                              fontSize: 13,
                                              fontWeight: FontWeight.w700,
                                              color: Color(0xFF1A2340))),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Read-only — download or share below',
      ...
      children: [
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text('$_actionsCount action${_actionsCount == 1 ? '' : 's'}',
                  style: const TextStyle(
        ...
        ...widget.sections.asMap().entries.expand((entry) {
          ...
          final actionQs = section.questions
              .where((q) => widget.actions.containsKey(q.code))
              .toList();
          if (actionQs.isEmpty) return <Widget>[];
          return [
            Padding(
              padding: const EdgeInsets.only(bottom: 6),
              child: Text(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Expanded(
                                  child: Text('${q.code}. ${action.title}',
                                      style: const TextStyle(
                                          fontSize: 13,
                                          fontWeight: FontWeight.w700,
                                          color: Color(0xFF1A2340)),
                            ...
                            Row(
                              children: [
                                ...
                                if (action.dueDate != null) ...[
                                  ...
                                  const SizedBox(width: 4),
                                  Text(_formatShortDate(action.dueDate!),
                                      style: const TextStyle(
                                          fontSize: 11,
                                          color: Color(0xFF9CA3AF),
                                          fontWeight: FontWeight.w500)),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: const Text('CHECKLIST SUMMARY/AUDIT',
              style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.w700,
  ...
  Widget _observationsCard() {
    return Container(
      ...
      child: Text(widget.observations,
          style: const TextStyle(
          ...
          children: [
            ...
            if (widget.signatureBytes != null) ...[
              ...
              Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(10),
                  child: Image.memory(widget.signatureBytes!,
                      fit: BoxFit.contain),
                ),
              ),
            ],
                  ...
                  child: SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side: const BorderSide(color: _headerColor, width: 1.5),
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(14)),
                        backgroundColor: _headerColor.withValues(alpha: 0.05),
                      ),
                    ),
                  ),
                ),
