...
class _StockpileReportPreviewPageState
  ...
  int get _actionsCount => _flaggedCount;
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) => [
          ...
          pw.Container(
            ...
            child: pw.Text('CHECKLIST SUMMARY/AUDIT',
                style: pw.TextStyle(
                    fontSize: 12,
                    fontWeight: pw.FontWeight.bold,
                    color: PdfColor.fromHex('#1F579C'))),
                ...
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: const Color(0xFFE0E3EA)),
                      boxShadow: [
                        BoxShadow(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Divider(
                            color: Color(0xFFE0E3EA), height: 1),
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      onPressed:
                          _isGenerating ? null : _downloadPdf,
                      icon: _isGenerating
                          ? const SizedBox(
                              width: 18,
                              height: 18,
