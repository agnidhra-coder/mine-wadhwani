...
//     // Build checklist data from sections + answers
...
//       }
//     } catch (_) {
//       // Signature capture failed, continue without it
//     }

//     if (!mounted) return;

//     // Set the checklist data in BLoC
//     context.read<ChecklistBloc>().add(SetCustomChecklistData(checklistData));

//     // Submit with completed: true
...
//                       // Pop back to the overview page and then back further
//                       Navigator.of(context).pop(); // pop compliance page
//                       Navigator.of(context).pop(); // pop overview page
//                     },
...
class _StockpileCompliancePageState extends State<StockpileCompliancePage> {
  ...
  // ── Signature state (replaces HandSignatureControl) ──
      ...
      child: ClipRRect(
        ...
        child: Stack(
          ...
          children: [
            // ── Drawing surface ──
            GestureDetector(
              // Prevent parent scroll from stealing touch events
              onPanStart: (details) {
                setState(() {
