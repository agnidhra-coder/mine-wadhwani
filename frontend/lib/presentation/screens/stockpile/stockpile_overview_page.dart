...
return Container(
height: 190, // keep same visual height as current header
color: _headerColor,
child: Stack(
fit: StackFit.expand,
children: [
// Right-side stockpile image
Positioned.fill(
  child: Align(
    ...
    child: Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage(
            'assets/images/stockpile_header.png',
          ),
          fit: BoxFit.cover,
        ),
      ),
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              _headerColor,
              _headerColor,
              _headerColor.withValues(alpha: 0.95),
              _headerColor.withValues(alpha: 0.40),
              Colors.transparent,
            ],
            stops: const [
             0.00,
