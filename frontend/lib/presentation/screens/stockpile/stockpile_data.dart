  ...
  static const List<StockpileSection> sections = [
    ...
    StockpileSection(
      ...
      questions: [
        ...
        StockpileQuestion(code: '2.2', text: 'For stockpiles exceeding 30 m in height, has benching been done with each bench not exceeding 30 m and overall slope not more than 1 Vertical:1.5 Horizontal?'),
        StockpileQuestion(code: '2.3', text: 'Is the bench height is less than 30 meter or less?'),
