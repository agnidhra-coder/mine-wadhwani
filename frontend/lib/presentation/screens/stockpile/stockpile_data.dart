  ...
  static const List<StockpileSection> sections = [
    StockpileSection(
      ...
      questions: [
        ...
        StockpileQuestion(
          code: '1.2',
          text: 'Approx. stockpile quantity',
          type: StockpileQuestionType.text,
          hint: 'Enter quantity in tonnes',
        ),
        StockpileQuestion(
          code: '1.3',
          text: 'Average stockpile height',
          type: StockpileQuestionType.text,
          hint: 'Enter height in metres',
        ),
        StockpileQuestion(
          code: '1.4',
          text: 'Approx. stockpile floor area',
          type: StockpileQuestionType.text,
    ...
    StockpileSection(
      ...
      questions: [
        ...
        StockpileQuestion(code: '2.6', text: 'Has a competent person assessed slope stability and are slope monitoring records up to date?'),
      ],
    ),
    StockpileSection(
      ...
      questions: [
        ...
        StockpileQuestion(code: '3.2', text: 'Is temperature monitoring being carried out at the stockpile for early detection of heating?'),
        StockpileQuestion(code: '3.3', text: 'Is carbonaceous shale stored separately and not mixed with the coal stockpile?'),
        StockpileQuestion(code: '3.4', text: 'Are dead leaves, dry vegetation and combustible waste cleared from around the stockpile?'),
        StockpileQuestion(code: '3.5', text: 'Is there adequate water supply at sufficient pressure available at the stockpile for fire-fighting purposes?'),
        StockpileQuestion(code: '3.6', text: 'Are portable fire extinguishers or sand/incombustible material provided at stockpile access points?'),
        StockpileQuestion(code: '3.7', text: 'Is the stockpile free from any active fire or smouldering?'),
        StockpileQuestion(code: '3.8', text: 'Is storage of inflammable materials (grease, oil, fuel) at least 15 m from stockpile area entrances?'),
      ],
    ),
    StockpileSection(
